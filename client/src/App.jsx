...
const copy = {
  ar: {
    ...
    supported: "المحاصيل الأولى: الزيتون، اللوز، الرمان، التين، العنب، الطماطم، البطاطا.",
    ...
    source: "المصدر العلمي", disclaimer: "هذه نتيجة احتمالية من صورة واحدة وليست تشخيصاً مخبرياً. يطابق التطبيق أمراض النبات فقط ولا يقيّم الآفات أو نقص العناصر. لا تستخدم دواءً أو مبيداً أو جرعة من التطبيق وحده.",
    ...
    unsupported: "المحصول غير مدعوم حالياً", unsupportedLead: "يدعم CropGuide حالياً سبعة محاصيل فقط. حاول صورة أوضح للمحصول نفسه.",
  ...
  fr: {
    ...
    supported: "Premières cultures : olivier, amandier, grenadier, figuier, vigne, tomate et pomme de terre.",
    ...
    source: "Source scientifique", disclaimer: "Ceci est une hypothèse issue d’une seule image, et non un diagnostic de laboratoire. L’application rapproche uniquement des maladies végétales, pas des ravageurs ni des carences. Ne choisissez ni pesticide ni dose à partir de cette application seule.",
    ...
    unsupported: "Culture non prise en charge", unsupportedLead: "CropGuide prend actuellement en charge sept cultures. Essayez une image plus nette de la même culture.",
  ...
  en: {
    ...
    supported: "First crops: olive, almond, pomegranate, fig, grapevine, tomato, and potato.",
    ...
    source: "Scientific source", disclaimer: "This is a probability from one image, not a laboratory diagnosis. The app matches plant diseases only, not pests or nutrient disorders. Do not select a pesticide or dose from this app alone.",
    ...
    unsupported: "Crop not supported yet", unsupportedLead: "CropGuide currently supports seven crops. Try a clearer image of the same crop.",
