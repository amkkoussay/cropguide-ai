const CACHE = "cropguide-shell-v6";
...
self.addEventListener("fetch", event => {
  ...
  // Always prefer a fresh deployed asset. The cache remains an offline fallback,
  // so a prior release can never pin the visible UI while the network is available.
  event.respondWith(
